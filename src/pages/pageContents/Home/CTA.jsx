...
const mainBuilding = "/assets/images/infrastructure/mainBuilding.JPG";
const aa = "/assets/images/infrastructure/aa.JPG";
  ...
  return (
    <div className=" min-[200px]:max-[1180px]:relative  flex desk:justify-center desk:mt-[100px] desk:max-[1919px]:mt-[80px] mt-[25px] desk:max-[1919px]:mb-[25px] desk:mb-[30px] mb-5 min-[200px]:max-[1180px]:justify-center">
      <div className="min-[200px]:max-[1180px]:w-full min-[200px]:max-[1180px]:px-5 ">
        <div className=" overflow-hidden   desk:h-[600px] desk:w-[960px] desk:max-[1919px]:h-[400px] desk:max-[1919px]:w-[640px] h-[500px]  desk:rounded-l-[300px] desk:rounded-r-3xl min-[500px]:max-[1180px]:rounded-t-3xl rounded-t-[300px] rounded-b-3xl">
          <img
            className="object-cover w-full h-full opacity-75 desk:opacity-100 dark:text-white"
            src={mainBuilding}
        ...
        <div className="flex flex-col justify-between h-full px-[52px] desk:py-[85px] desk:max-[1919px]:py-[62px] gap-8">
          ...
          <div className="flex justify-between desk:w-[450px] min-[200px]:max-[1180px]:flex-col gap-2">
            <Link
              ...
              className="rounded-full px-6 py-[15px] bg-[#048AF9] text-center hover:bg-[#0376d1] font-inter font-medium desk:max-[1919px]:text-lg desk:text-xl text-white"
            >
              Apply now
            </Link>
            <a
              ...
              target="_blank"
              className="rounded-full text-center px-6 py-[15px] font-inter font-medium desk:max-[1919px]:text-lg desk:text-xl dark:text-white hover:text-white hover:bg-[#048af9] border-[1px] border-[#048af9] transition ease-in-out duration-300"
            >
              Download Prospectus
            </a>
          </div>
