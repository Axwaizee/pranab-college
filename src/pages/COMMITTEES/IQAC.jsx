        ...
        <div className="w-full desk:w-1/2">
          <div className="pt-1 ">
            <p className="text-justify ">
              ...
              functions of the institution. Established in line with the
              guidelines of the National Assessment and Accreditation Council
              (NAAC), the IQAC's primary aim is to develop a system for
            ...
            <ol className="list-decimal list-inside ">
              <li className="pb-2">Promoting Quality Improvement </li>
              <li className="pb-2">Ensuring Consistency </li>
              <li className="pb-2">
                Facilitating a Learner-Centric Environment 
              </li>
              <li className="pb-2">Encouraging Research and Innovation </li>
              <li className="pb-2">Stakeholder Engagement </li>
              <li className="pb-2">Institutionalizing Best Practices </li>
              <li className="pb-2">Promoting a Culture of Excellence </li>
            </ol>
            <br />
            <p>
            ...
            <br />
            <p>
               Together, we look forward to the future with optimism and a
              renewed commitment.
            </p>
          </div>
        </div>
