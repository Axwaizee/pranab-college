        ...
        <div className="w-full desk:w-2/3">
          <div className="pt-1 ">
            <div className="flex justify-center py-5">
              <iframe
                className="desk:w-full min-[200px]:max-[1180px]:w-full min-[200px]:max-[1180px]:h-[600px] h-[1000px]"
                src="https://drive.google.com/file/d/1QGwrkmhg9HCV5ZasmrmKcH0SFs9nzgbA/preview"
