    ...
    <>
      ...
      <div className="flex justify-center p-5 desk:p-10">
        <div className="w-full desk:w-3/4 dark:text-white">
          ...
          <div>
            <p className="pb-3 ">
              <b>AIMS AND OBJECTIVES OF THE RESEARCH COMMITTEE</b>
            </p>
          ...
          <div>
            ...
            <ul className="list-disc list-inside">
              ...
              <li className="pb-2">
                ...
                and faculty exchange program to encourage research.
              </li>
              <li className="pb-2">
                To organize departmental talk or lecture and seminar for
              ...
              <li className="pb-4">
                ...
                <ul className="pl-8 list-decimal list-inside">
                  <li className="pb-4">
                    ...
                    Programme under Malaviya Mission Teacher Training
                    Programme(MM-TTP) of University Grants Commission organised
                    by MMTTC, Central University of Haryana, Mahendergarh
                    (India) from Feb 5-14, 2024.
                  </li>
                  <li className="pb-4">
                    Published article on the topic “Integrating Skills to
                    Prepare Students for 21st Century – As per NEP 2020”
                    published in Public College Journal of Economics & Commerce,
                    Vol XIII, in 2023.
                  </li>
                  <li className="pb-4">
                    Published book Communication Skills (As per latest
                    curriculum of the directives of NEP 2020) Nagaland
